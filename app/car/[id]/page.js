  ...
  return (
    <div className="container mx-auto">
      <div className="grid grid-cols-3 grid-flow-row">
        ...
        <div className="md:max-w-screen-lg bg-white rounded-[10px] p-6 col-span-1">
          ...
          <div className="md:mt-8">
            <p className="text-xl text-[#596780] font-light">
            NISMO has become the embodiment of Nissan outstanding performance, inspired by the most unforgiving proving ground.
            </p>

            <div className="grid grid-cols-2 grid-rows-2 md:mt-8 gap-x-11 gap-y-4">
